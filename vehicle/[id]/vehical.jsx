...
const VehicleDetailScreen = () => {
  ...
  const handleEdit = () => {
    router.push({
      pathname: '/tabs/options/edit_specifications',
  ...
  const handleUpdateMileage = () => {
    router.push({
      pathname: '/tabs/options/mileage_update',
      params: { vehicleId: selectedVehicleId }
    });
  };
  ...
  const handleAddSpecs = () => {
    router.push({
      pathname: '/tabs/service_records/service_ongoing',
      params: { vehicleId: selectedVehicleId }
    });
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.actionButtonsContainer}>
        ...
        {/* Add Specs Button */}
        <TouchableOpacity
          style={[styles.actionButton, styles.addSpecsButton, { backgroundColor: theme.secondary || theme.primary }]}
          onPress={handleAddSpecs}
        >
          <Ionicons name="add-circle" size={20} color="white" style={styles.buttonIcon} />
          <Text style={styles.actionButtonText}>Add Specs</Text>
        </TouchableOpacity>
      </View>
